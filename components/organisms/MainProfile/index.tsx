      ...
      <profileStyle.ContentCard>
        <profileStyle.ContentText>
          ...
          <p style={{ textAlign: "left" }}>
            ...
            디자이너와 개발자 간의 소통의 어려움은 서로간의 도메인 지식들의
            부재로 인해서 발생한다고 생각하고 서로의 업무에 대한 이해도 부족으로
            인한 소통의 어려움는 프로젝트를 안 좋은 방향으로 흘러가게 만든다고
            봅니다.
            <br />
            <br />
            저는 기술과 예술, 논리와 감성의 균형을 유지합니다. 아름다움을
            추구하되 사람들의 사용성은 높아야 하며 미적인 완성도를 지키면서
            세련된 움직임으로 생명력을 부여해야합니다. 그리고 일의 목적을 잃지
